...
import { DEFAULT_LOG_METHOD_NAMES, type LoggerOptions, type LogMethodNames, type StandardLog } from './standard_log.js'
...
export function buildLogContext<N extends string = LogMethodNames>(
	...
	logMethods.forEach(m => {
		;(log as any)[m] = (appLogger as any)[m].bind(appLogger)
	})
	return log
}
