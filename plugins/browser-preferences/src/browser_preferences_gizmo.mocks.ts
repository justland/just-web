import { type JustAppTestOptions, justTestApp } from '@just-web/app/testing'
...
export function browserPreferencesGizmoTestApp(options?: JustAppTestOptions & { browser?: BrowserTestGizmoOptions }) {
